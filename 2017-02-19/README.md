...
5. [x] Create a basic test example with mocha and chai. test file in es6.
5. [x] Create a basic flow example that works with webpack, babel, eslint, and syntastic
